                ...
                <div class="col-lg-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>YUK DAFTAR SEGERA!!</h1>
                            <p>Berikut daftar siswa yang sudah terdaftar </p>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row">
              <div class="col-sm-8 col-md-4 col-lg-4">
                  <div class="single_footer_part">
                      ...
                      <p> SMK Adi Sanggoro adalah sekolah yang terakreditasi A <br>Jln. Sengked No. 1 Kampus IPB Dramaga Bogor
              ...
              <div class="col-sm-4 col-md-4 col-lg-2">
                  <div class="single_footer_part">
                      ...
                      <ul class="list-unstyled">
                          ...
                          <li><a href="">Geologi Pertambangan</a></li>
              ...
              <div class="col-sm-4 col-md-4 col-lg-2">
                  <div class="single_footer_part">
                      <h4>My Account</h4>
                      <ul class="list-unstyled">
                          <li><a href="">Ig : @smkadisanggoro_official</a></li>
                          <li><a href="">Telephone : 02518621133 </a></li>
                          <li><a href="">Youtube : SMK ADI SANGGORO CHANNEL</a></li>
                          <li><a href="">Facebook : SMK Adi Sanggoro</a></li>
                      </ul>
                  </div>
              </div>
              <div class="col-sm-4 col-md-3 col-lg-2">
                  <div class="single_footer_part">
                      ...
                      <ul class="list-unstyled">
                          ...
                          <li><a href="">REISAS</a></li>
                          <li><a href="">PMR</a></li>
                          <li><a href="">Perisai Diri</a></li>
                          <li><a href="">Paladis</a></li>
                          <li><a href="">BKC</a></li>
                          <li><a href="">Tari</a></li>
                      </ul>
                  </div>
